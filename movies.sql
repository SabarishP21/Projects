...
INSERT INTO movies VALUES('Beast','Vijay','Pooja',2022,'Nelson');
INSERT INTO movies VALUES('Doctor','Sivakarthikeyan','Priyanka mohan',2021,'Nelson');
...
SELECT movie_name FROM movies WHERE lead_actor='Vijay' AND actress='Pooja' AND year_of_release=2022;
...
-- 6. Retrieving all the 'movie_name','director_name' from 'movies' table that are not directed by 'Nelson'
SELECT movie_name,director_name FROM movies WHERE director_name!='Nelson';
